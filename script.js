...
const versions = [
  ...
  },
  {
    ...
    tag: "Secured-Core",
    tagColor: "tag-red",
    summary: "La versión más reciente con soporte activo. Su enfoque principal fue la seguridad bajo el concepto de Secured-Core Server: arranque seguro, protección de firmware y TPM 2.0. Incorporó TLS 1.3 y DNS sobre HTTPS de forma nativa. SMB sobre QUIC permite acceso seguro a recursos compartidos sin necesidad de VPN. Azure Arc profundiza la gestión híbrida.",
    keyFeatures: [
